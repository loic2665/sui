    ...
    return (
        (obj === "All" ||
            ...
            (obj !== null &&
                typeof obj === "object" ||
                typeof obj === "function") &&
            isOwner(obj.Recipient) as boolean ||
            (obj !== null &&
                typeof obj === "object" ||
                typeof obj === "function") &&
            isTransactionDigest(obj.Object) as boolean ||
...
export function isSuiEventEnvelope(obj: any, _argumentName?: string): obj is SuiEventEnvelope {
    return (
        (obj !== null &&
            typeof obj === "object" ||
            typeof obj === "function") &&
        isSuiMoveTypeParameterIndex(obj.id) as boolean &&
...
export function isOwner(obj: any, _argumentName?: string): obj is Owner {
    return (
        (obj === "Shared" ||
            obj === "Immutable" ||
            (obj !== null &&
